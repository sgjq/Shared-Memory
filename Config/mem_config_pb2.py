...
_MEMORYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='MemoryId', full_name='MyMessage.MemoryConfig.MemoryId', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='SemaporeId', full_name='MyMessage.MemoryConfig.SemaporeId', index=5,
